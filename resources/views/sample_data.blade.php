<html>
 ...
 <body>
  <div class="container">
     <br />
     <h3 text-align="center">How to Delete or Remove Data From Mysql in Laravel 6 using Ajax</h3>
     <br />
    ...
    <table id="user_table" class="table table-bordered table-striped">
     <thead>
      <tr>
            ...
            <th width="15%">create_at</th>
            <th width="15%">update_at</th>
...
//找到ID  使用Datables的Method
//初始化設定
 $('#user_table').DataTable({
  processing: true,
  serverSide: true,
  ajax: {
      //去samplecontroller的index()
